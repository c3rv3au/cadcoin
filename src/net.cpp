...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cadcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"toutrix.com", "cadseed.toutrix.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"toutrix.com", "testnet-cadseed.toutrix.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cadcoin is probably already running."), addrBind.ToString().c_str());
        else
